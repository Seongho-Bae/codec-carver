...
## [Unreleased]
### Added
- 사용자가 필수 입력 필드(파일 크기, 파일 선택 등)의 내용을 비웠을 때, 오류 상태가 해제되는 대신 명확한 시각적 오류 메시지('This field is required.')와 함께 `aria-invalid='true'` 속성을 설정하여 접근성과 폼 유효성 검증 사용자 경험을 개선했습니다.
