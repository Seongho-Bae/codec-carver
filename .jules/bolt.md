## 2024-06-25 - [Optimize Path.stat() vs os.stat()]
**Learning:** Using `pathlib.Path.stat()` creates a new object which has significant overhead when called iteratively (e.g. loops) compared to `os.stat()`.
